...
- `amo-personal-ip-illustrations/SKILL.md` 是主源。
- `references/` 是跨平台知识库。
...
```text
Use $amo-personal-ip-illustrations 为这篇内容生成 4 张正文配图。
```
...
```text
/skill amo-personal-ip-illustrations
```

Hermes skill 推荐放在：

```text
$HERMES_HOME/skills/creative/amo-personal-ip-illustrations/SKILL.md
```
...
```text
Read llms.txt first, then read amo-personal-ip-illustrations/SKILL.md and references/prompt-template.md.
