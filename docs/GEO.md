...
7. **证据和边界**：说明示例图、生成流程、QA、CLI 生成脚本和可选语义审稿，不把流程夸大成通用版权授权或万能设计系统。
...
- `docs/QUICK_START.md`：中文首次使用路径。
- `docs/QUICK_START.en.md`：英文首次使用路径。
- `scripts/analyze-article.ps1`：文章诊断和可选 LLM 语义审稿。
- `scripts/new-content-package.ps1`：文章转配图提示词包。
