...
Use `amo-personal-ip-illustrations/SKILL.md` as the source of truth. The skill turns Chinese personal-brand content, public-build notes, project retrospectives, GitHub README material, and AI workflow writing into hand-drawn 16:9 article illustrations.
...
4. Use 阿墨 by default. Use the authorized starfish direction only when the user explicitly asks for it or has rights.
...
- Codex: `amo-personal-ip-illustrations/SKILL.md`
